...
const packet = {
  ...
  rows: 1,
  frameCells: 2,
  bitmapUploadsCount: 1,
  bitmapUploads: new DataView(new Uint32Array([0, 1, 0, 2]).buffer),
  bitmapUploadPixels: new Uint8Array(2),
  canvasRequestsCount: 1,
  canvasRequests: new DataView(new Uint32Array([1, 1, 1, 0, 1, 0]).buffer),
  canvasText: new TextEncoder().encode("a"),
  stylesFirst: 0,
  styles: new Uint32Array(3),
  styleBytes: new Uint8Array(12),
  dirtyRangesCount: 1,
  dirtyRanges: new DataView(new Uint32Array([0, 1]).buffer),
  cells: new Uint8Array(16),
  selections: new Uint32Array(1),
};
const backend = {
  initialized: true,
  activeTerminal: core,
  ...
  uploadBitmap(...args) {
    operations.push(args[0] === 0 ? "bitmap" : "canvas");
  },
  uploadStyles() {
    operations.push("styles");
